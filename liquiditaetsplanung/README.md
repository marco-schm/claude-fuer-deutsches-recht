...
| --- | --- | --- |
| **Liquiditätsplanung — Power-Plugin-Werkstatt** | Vollständiger Arbeits-Prompt mit Werkstattlogik, Pflicht-Schritten, Quellen-Disziplin und Antwort-Skeletten. Darf lang sein. | [`liquiditaetsplanung-werkstatt.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/liquiditaetsplanung-werkstatt.zip) |
| **Liquiditätsplanung — Power-Plugin-Schnellstart** | Kompakter Einstiegs-Prompt, höchstens 7.500 Zeichen. Für den schnellen Wurf in einen Chat. | [`liquiditaetsplanung-schnellstart.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/liquiditaetsplanung-schnellstart.zip) |

Wer die Markdown-Datei lieber im Browser ansehen statt herunterladen will:
- [`liquiditaetsplaner-werkstatt.md`](./liquiditaetsplaner-werkstatt.md) (im Browser ansehen)
- [`liquiditaetsplaner-schnellstart.md`](./liquiditaetsplaner-schnellstart.md) (im Browser ansehen)
