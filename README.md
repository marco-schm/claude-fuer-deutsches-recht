...
| **Plugin-Version / Arbeitsstand** | `v361.0.0` — [latest Release auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
...
- **Insolvenz & Sanierung** – Einstieg über [`plugin-gruppen/insolvenzrecht/`](./plugin-gruppen/insolvenzrecht/) mit Routing nach Krise, Forderungsanmeldung, Insolvenzverwaltung, Insolvenzplan/StaRUG, Verbraucherinsolvenz, Fortbestehensprognose und US-Bankruptcy-Schnittstelle; die Einzelplugins bleiben `insolvenzrecht`, `insolvenzverwaltung`, `zwangsverwaltung-zvg`, `insolvenzforderungsanmeldungspruefung`, `insolvenzplan-starug-planwerkstatt`, `fortbestehensprognose`, `krisenfrueherkennung-starug`, `liquiditaetsplanung`, `verbraucherinsolvenz-schuldenbereinigung`, `fachanwalt-insolvenz-sanierungsrecht` und `us-bankruptcy-code`.
...
- **Insolvenz, Sanierung und Krisenmanagement (erweitert)** – gebündelt in [`plugin-gruppen/insolvenzrecht/`](./plugin-gruppen/insolvenzrecht/): Frühwarnung nach § 1 StaRUG, Beraterwarnpflicht § 102 StaRUG, Zahlungsunfähigkeit, Überschuldung, Restrukturierungsplan, Insolvenzplan, Eigenverwaltung, Schutzschirm, Forderungstabelle, Verwalterberichte und Cross-Border-Fälle.
