...
|---|---|
| **Plugins** | 215 |
| **Skills (SKILL.md)** | 25732 — [Gesamtübersicht](./SKILLS.md) |
| **Testakten** | 208 |
| **Fachanwalts-/-anwältinnen-Profile** | 24 |
| **Plugin-Version / Arbeitsstand** | `v352.0.0` — [latest Release auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
