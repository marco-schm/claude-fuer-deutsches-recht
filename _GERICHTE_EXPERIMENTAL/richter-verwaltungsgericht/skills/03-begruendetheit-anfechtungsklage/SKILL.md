...
description: "Begruendetheit Paragraf 113 Abs. 1 VwGO: Rechtmaessigkeit des Verwaltungsakts (Rechtsgrundlage, formelle und materielle Rechtmaessigkeit), subjektives Recht des Klaegers"
---

# 03 Begruendetheit Anfechtungsklage

## Zweck

Begruendetheit Paragraf 113 Abs. 1 VwGO: Rechtmaessigkeit des Verwaltungsakts (Rechtsgrundlage, formelle und materielle Rechtmaessigkeit), subjektives Recht des Klaegers
...
- **Davor**: `02-amtsermittlung-und-sachverhaltsfeststellung` - Nutze diesen Vorgaenger fuer die vorgelagerte Akten-, Zulassigkeits- oder Strukturfrage, bevor 03 Begruendetheit Anfechtungsklage bearbeitet wird.
- **Danach**: `04-begruendetheit-verpflichtungsklage` - Nutze diesen Folgeschritt, sobald 03 Begruendetheit Anfechtungsklage als gerichtlicher Arbeitsstand verwertbar ist.
