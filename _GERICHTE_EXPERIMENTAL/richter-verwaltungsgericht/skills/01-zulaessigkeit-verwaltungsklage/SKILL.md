...
description: "Zulaessigkeit der Klage: Verwaltungsrechtsweg Paragraf 40 VwGO, Klagearten Paragrafen 42 113 (Anfechtung Verpflichtung Feststellung), Klagebefugnis, Vorverfahren Paragraf 68, Frist Paragraf 74"
---

# 01 Zulaessigkeit Verwaltungsklage

## Zweck

Zulaessigkeit der Klage: Verwaltungsrechtsweg Paragraf 40 VwGO, Klagearten Paragrafen 42 113 (Anfechtung Verpflichtung Feststellung), Klagebefugnis, Vorverfahren Paragraf 68, Frist Paragraf 74
...
- BVerfG 1 BvR 569/05 (12.05.2005): Effektiver Eilrechtsschutz verlangt eine Folgenabwaegung, wenn die Hauptsache nicht rechtzeitig geklaert werden kann.
- BVerfG 2 BvR 2735/14 (15.12.2015): Art. 19 Abs. 4 GG verlangt wirksame gerichtliche Kontrolle belastender Hoheitsakte.
- BVerwG 1 VR 1.11 (13.09.2011): Eilrechtsschutz muss Rechtmaessigkeitspruefung und Interessenabwaegung nachvollziehbar verbinden.
...
```text
Der Beklagte wird verpflichtet, den Antrag der Klaegerin vom [Datum] unter Beachtung der Rechtsauffassung des Gerichts neu zu bescheiden.
```

## Benachbarte Skills

- **Davor**: `10-entscheidungsvorschlag-verwaltungsgericht` - Nutze diesen Vorgaenger fuer die vorgelagerte Akten-, Zulassigkeits- oder Strukturfrage, bevor 01 Zulaessigkeit Verwaltungsklage bearbeitet wird.
- **Danach**: `02-amtsermittlung-und-sachverhaltsfeststellung` - Nutze diesen Folgeschritt, sobald 01 Zulaessigkeit Verwaltungsklage als gerichtlicher Arbeitsstand verwertbar ist.
