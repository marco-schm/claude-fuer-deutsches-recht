...
description: "Firmenpruefung Paragrafen 17-37a HGB: Kennzeichnungseignung, Unterscheidbarkeit (Paragraf 30 HGB), Irrefuehrungsverbot (Paragraf 18 Abs. 2), Rechtsformzusatz, Sitzangabe"
---

# 02 Firmenrecht Pruefen

## Zweck

Firmenpruefung Paragrafen 17-37a HGB: Kennzeichnungseignung, Unterscheidbarkeit (Paragraf 30 HGB), Irrefuehrungsverbot (Paragraf 18 Abs. 2), Rechtsformzusatz, Sitzangabe
...
4. Behebbares Hindernis als Zwischenverfuegung, unbehebbares Hindernis als Zurueckweisung behandeln.
   - Verdichte den Aktenstoff fuer 02 Firmenrecht Pruefen: Firmenpruefung Paragrafen 17-37a HGB: Kennzeichnungseignung, Unterscheidbarkeit (Paragraf 30 HGB), Irrefuehrungsverbot (Paragraf 18 Abs. 2), Rechtsformzusatz, Sitzangabe
...
- **Davor**: `01-anmeldung-pruefen-zustaendigkeit` - Nutze diesen Vorgaenger fuer die vorgelagerte Akten-, Zulassigkeits- oder Strukturfrage, bevor 02 Firmenrecht Pruefen bearbeitet wird.
- **Danach**: `03-gesellschaftsvertrag-pruefen-gmbh` - Nutze diesen Folgeschritt, sobald 02 Firmenrecht Pruefen als gerichtlicher Arbeitsstand verwertbar ist.
