...
description: "Einkommensteuer-Pruefung: Einkunftsart, Einkunftsermittlung (Paragrafen 4 und 5 EStG oder Paragraf 11 EStG), Sonderausgaben, aussergewoehnliche Belastungen, Tarif Paragraf 32a EStG"
---

# 05 Est Pruefungsschema

## Zweck

Einkommensteuer-Pruefung: Einkunftsart, Einkunftsermittlung (Paragrafen 4 und 5 EStG oder Paragraf 11 EStG), Sonderausgaben, aussergewoehnliche Belastungen, Tarif Paragraf 32a EStG
...
2. Bescheidart, Besteuerungsgrundlagen und Aenderungsnorm bestimmen.
   - Verdichte den Aktenstoff fuer 05 Est Pruefungsschema: Einkommensteuer-Pruefung: Einkunftsart, Einkunftsermittlung (Paragrafen 4 und 5 EStG oder Paragraf 11 EStG), Sonderausgaben, aussergewoehnliche Belastungen, Tarif Paragraf 32a EStG
...
- **Davor**: `04-steuerbescheid-pruefen` - Nutze diesen Vorgaenger fuer die vorgelagerte Akten-, Zulassigkeits- oder Strukturfrage, bevor 05 Est Pruefungsschema bearbeitet wird.
- **Danach**: `06-ust-pruefungsschema` - Nutze diesen Folgeschritt, sobald 05 Est Pruefungsschema als gerichtlicher Arbeitsstand verwertbar ist.
