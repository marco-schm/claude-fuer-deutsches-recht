...
description: "Pruefung des angegriffenen Steuerbescheids: formelle Rechtmaessigkeit (Begruendung Paragraf 121 AO, Bekanntgabe Paragraf 122), materielle Pruefung der Steuerart"
---

# 04 Steuerbescheid Pruefen

## Zweck

Pruefung des angegriffenen Steuerbescheids: formelle Rechtmaessigkeit (Begruendung Paragraf 121 AO, Bekanntgabe Paragraf 122), materielle Pruefung der Steuerart
...
2. Bescheidart, Besteuerungsgrundlagen und Aenderungsnorm bestimmen.
   - Verdichte den Aktenstoff fuer 04 Steuerbescheid Pruefen: Pruefung des angegriffenen Steuerbescheids: formelle Rechtmaessigkeit (Begruendung Paragraf 121 AO, Bekanntgabe Paragraf 122), materielle Pruefung der Steuerart
...
- **Davor**: `03-aussetzung-der-vollziehung` - Nutze diesen Vorgaenger fuer die vorgelagerte Akten-, Zulassigkeits- oder Strukturfrage, bevor 04 Steuerbescheid Pruefen bearbeitet wird.
- **Danach**: `05-est-pruefungsschema` - Nutze diesen Folgeschritt, sobald 04 Steuerbescheid Pruefen als gerichtlicher Arbeitsstand verwertbar ist.
