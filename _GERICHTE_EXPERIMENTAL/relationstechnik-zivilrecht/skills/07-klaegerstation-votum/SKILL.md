...
description: "Schriftliches Votum der Klaegerstation: Anspruchsgrundlage, gepruefte Tatbestandsmerkmale, schluessige Rechtsfolge oder nicht schluessig, Hinweise nach Paragraf 139 ZPO"
---

# 07 Klaegerstation Votum

## Zweck

Schriftliches Votum der Klaegerstation: Anspruchsgrundlage, gepruefte Tatbestandsmerkmale, schluessige Rechtsfolge oder nicht schluessig, Hinweise nach Paragraf 139 ZPO
...
3. Beklagtenstation: Bestreiten, Einwendungen, Einreden und Replikfaehigkeit ordnen.
   - Verdichte den Aktenstoff fuer 07 Klaegerstation Votum: Schriftliches Votum der Klaegerstation: Anspruchsgrundlage, gepruefte Tatbestandsmerkmale, schluessige Rechtsfolge oder nicht schluessig, Hinweise nach Paragraf 139 ZPO
...
- **Davor**: `06-schluessigkeit-pruefen` - Nutze diesen Vorgaenger fuer die vorgelagerte Akten-, Zulassigkeits- oder Strukturfrage, bevor 07 Klaegerstation Votum bearbeitet wird.
- **Danach**: `08-beklagtenvortrag-strukturieren` - Nutze diesen Folgeschritt, sobald 07 Klaegerstation Votum als gerichtlicher Arbeitsstand verwertbar ist.
