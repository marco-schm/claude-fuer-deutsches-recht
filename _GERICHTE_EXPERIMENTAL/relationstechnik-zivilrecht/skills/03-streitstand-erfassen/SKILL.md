...
3. Beklagtenstation: Bestreiten, Einwendungen, Einreden und Replikfaehigkeit ordnen.
   - Verdichte den Aktenstoff fuer 03 Streitstand Erfassen: Streitiger und unstreitiger Sachverhalt heraussortieren, Geltung von Paragraf 138 Abs. 3 ZPO (Gestaendnisfiktion), Beweisbeduerftigkeit der streitigen Tatsachen
...
- **Davor**: `02-parteivortrag-strukturieren` - Nutze diesen Vorgaenger fuer die vorgelagerte Akten-, Zulassigkeits- oder Strukturfrage, bevor 03 Streitstand Erfassen bearbeitet wird.
