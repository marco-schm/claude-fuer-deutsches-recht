...
description: "Zustaendigkeit Strafrichter oder Schoeffengericht (Paragraf 25 oder 28 GVG), Eroeffnung Paragrafen 199-203 StPO, Nichteroeffnung oder Ablehnung mit Begruendung"
---

# 02 Zustaendigkeit Und Eroeffnungsbeschluss

## Zweck

Zustaendigkeit Strafrichter oder Schoeffengericht (Paragraf 25 oder 28 GVG), Eroeffnung Paragrafen 199-203 StPO, Nichteroeffnung oder Ablehnung mit Begruendung
...
- BGH 1 StR 618/98 (30.07.1999): In Aussage-gegen-Aussage-Konstellationen sind Aussageentstehung, Aussagekonstanz und Belastungsmotive besonders sorgfaeltig zu wuerdigen.
- BVerfG 2 BvR 2628/10 und 2 BvR 2883/10 und 2 BvR 2155/11 (19.03.2013): Verstaendigungen muessen transparent, dokumentiert und revisionskontrollierbar bleiben.
- BGH GSSt 1/17 (15.05.2018): Beweisantragsrecht und Aufklaerungspflicht muessen so gehandhabt werden, dass die Wahrheitsfindung nicht formal entleert wird.
- BGH 3 StR 400/17 (18.07.2018): Urteilsgruende muessen die fuer Schuldspruch und Rechtsfolgen tragenden Beweiserwaegungen erkennen lassen.

## Pruefungsschema in Stufen

1. Zustaendigkeit, Besetzung und Eroeffnungsreife pruefen.
...
4. Beweiswuerdigung nach Paragraf 261 StPO ohne Vorfestlegung erarbeiten.
   - Formuliere nur aktengetragene Ermittlungs-, Hinweis- oder Beweisfragen und trenne Aufklaerung von vorlaeufiger Bewertung.
...
- Der Strafbefehl wird wie ein Urteil begruendet, obwohl andere Form- und Einspruchslogik gilt.
- Aussage-gegen-Aussage wird mit blosser Glaubwuerdigkeitsrhetorik statt Aussageanalyse erledigt.
- Beweisantraege werden ohne tragfaehigen Ablehnungsgrund beschieden.
...
```text
Der Beweisantrag vom [Datum] wird zurueckgewiesen, weil [Ablehnungsgrund] nach Paragraf 244 StPO vorliegt. Die Kammer beziehungsweise das Gericht stuetzt dies auf folgende konkrete Umstaende: [Umstaende].
```

## Benachbarte Skills

- **Davor**: `01-akte-erstdurchsicht-strafsache` - Nutze diesen Vorgaenger fuer die vorgelagerte Akten-, Zulassigkeits- oder Strukturfrage, bevor 02 Zustaendigkeit Und Eroeffnungsbeschluss bearbeitet wird.
- **Danach**: `03-hauptverhandlung-vorbereiten` - Nutze diesen Folgeschritt, sobald 02 Zustaendigkeit Und Eroeffnungsbeschluss als gerichtlicher Arbeitsstand verwertbar ist.
