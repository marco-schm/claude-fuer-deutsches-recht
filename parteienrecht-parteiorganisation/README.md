...
| **Alle Skills als Markdown** | [`parteienrecht-parteiorganisation-skills-markdown.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/parteienrecht-parteiorganisation-skills-markdown.zip) |
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`parteienrecht-parteiorganisation.md`](../unified-mini-prompts/parteienrecht-parteiorganisation.md) oder als Sammel-ZIP [`alle-unified-mini-prompts.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/alle-unified-mini-prompts.zip) |
...
| `beschlussvorlagen-partei-bewerberzustimmung` | Formuliert Beschlüsse, Anträge, Satzungsänderungen, Geschäftsordnungsanträge und Verfahrensbeschlüsse im Parteienrecht. |
| `bewerberzustimmung` | Erklärt Zustimmungserklärung, Wählbarkeit, Parteimitgliedschaft, Mehrfachkandidatur und Nachweise im Parteienrecht. |
...
| `europawahl-partei-fraktionsschnittstelle` | Prüft Europawahl-Vorschläge, Bundes-/Landesliste, Vertreterversammlung, Formulare und Bundeswahlleiter-Kommunikation im Parteienrecht. |
| `fraktionsschnittstelle` | Trennt Partei, Fraktion, Mandat, Ressourcen, Personal, Spenden und Öffentlichkeitsarbeit im Parteienrecht. |
...
| `fristkalender-partei-abgeordnetengesetz-bund` | Erstellt Fristenkalender für Versammlungen, Wahlvorschläge, Rechenschaft, Spendenmeldungen, Satzungsfristen im Parteienrecht. |
| `gebietsgliederung` | Ordnet Bundes-, Landes-, Bezirks-, Kreis-, Ortsverband, Arbeitsgemeinschaften und Zuständigkeiten im Parteienrecht. |
| `geheime-abstimmung` | Prüft wann geheime Wahl/Abstimmung nötig ist, Stimmzettel, Urne, Auszählung und Dokumentation. |
| `geheime-abstimmung-geschaeftsordnung` | Prüft wann geheime Wahl/Abstimmung nötig ist, Stimmzettel, Urne, Auszählung und Dokumentation im Parteienrecht. |
...
| `kandidatenaufstellung-bundestag` | Begleitet Aufstellung Direktkandidat: wahlberechtigte Mitglieder, geheime Abstimmung, Niederschrift, Zustimmung, eidesstattliche Versicherung im Parteienrecht. |
...
| `koalitions-listenverbindung-kommunalmandat` | Prüft wahlrechtlich zulässige Kooperationen, gemeinsame Listen, Wählergruppen und Satzung im Parteienrecht. |
...
| `landesliste-bundestag-landesrecht` | Begleitet Landeslistenaufstellung: Delegierten-/Mitgliederversammlung, Reihenfolge, geheime Wahl, Unterlagen, Fristen, Landeswahlleiter im Parteienrecht. |
...
| `mandatstraegerbeitraege` | Prüft satzungsrechtliche Mandatsträgerbeiträge, Abgrenzung Spende/Beitrag und Abgeordnetenrecht im Parteienrecht. |
...
| `minderheitenrechte-partei-mitgliederdaten` | Prüft Antragsrechte, Sonderparteitag, Delegiertenprüfung, Informationsrechte und Gleichbehandlung im Parteienrecht. |
| `mitgliederdaten-dsgvo` | Regelt Mitgliederverzeichnis, Zugriff, Export, Wahlberechtigung, Löschung, Auskunft und Sicherheit. |
| `mitgliederrechte` | Erklärt Aufnahme, Stimmrecht, Antragsrecht, Gleichbehandlung, Datenschutz, Mitgliedsbeiträge und Austritt im Parteienrecht. |
| `mitgliederversammlung-kleine-kreis` | Niedrigschwelliger für kleine Kreisverbände: Einladung, Beschlussfähigkeit, Protokoll, Wahlleiterkontakte im Parteienrecht. |
| `mitgliederversammlung-kleine-partei` | Kleine Partei Praxis im Parteienrecht: 1. Welche Rolle hat die betroffene Person oder Organisation? 2. Welche Frist, welcher Termin oder welche Sanktion steht im Raum? 3. Welche Behörde, welches Gericht, welches Register, welcher Verband... |
...
| `niederschrift-aufstellungsversammlung-online` | Erstellt Niederschrift mit Wahlmodus, Stimmberechtigung, geheimer Abstimmung, Ergebnissen und Versicherungen im Parteienrecht. |
...
| `ordnungsmassnahmen-parteiausschluss` | Routet Rüge, Amtsenthebung, Ruhen von Rechten, Eilmaßnahme und satzungsrechtliche Grundlage im Parteienrecht. |
| `parteiausschluss` | Prüft Parteiausschluss, schwerer Schaden, Anhörung, Vorstandsantrag, Schiedsgericht und Verhältnismäßigkeit im Parteienrecht. |
| `parteidokumentenpaket` | Erzeugt komplette Pakete: Einladung, TO, Wahlordnung, Stimmzettel, Niederschrift, Versicherungen, Wahlleiteranschreiben im Parteienrecht. |
...
| `parteienprivileg-verfassung-parteigericht` | Erklärt Art. 21 GG, Parteienprivileg, Chancengleichheit, staatliche Neutralität und formale Relevanz im Parteienrecht. |
| `parteienrecht-beitragsordnung-satzung-finanzierung` | Prüft Mitgliedsbeiträge, Mandatsträgerbeiträge, Ermäßigung, Mahnung, Transparenz und Satzungsgrundlage. |
| `parteienrecht-bewerberzustimmung-wahlvorschlag` | Erklärt Zustimmungserklärung, Wählbarkeit, Parteimitgliedschaft, Mehrfachkandidatur und Nachweise. |
| `parteienrecht-dokumentenpaket-versammlung-wahl` | Erzeugt komplette Pakete: Einladung, TO, Wahlordnung, Stimmzettel, Niederschrift, Versicherungen, Wahlleiteranschreiben. |
| `parteienrecht-fraktion-partei-abgrenzung` | Trennt Partei, Fraktion, Mandat, Ressourcen, Personal, Spenden und Öffentlichkeitsarbeit. |
| `parteienrecht-gebietsgliederung-untergliederung` | Ordnet Bundes-, Landes-, Bezirks-, Kreis-, Ortsverband, Arbeitsgemeinschaften und Zuständigkeiten. |
...
| `parteienrecht-mitgliederrechte-innerparteilich` | Erklärt Aufnahme, Stimmrecht, Antragsrecht, Gleichbehandlung, Datenschutz, Mitgliedsbeiträge und Austritt. |
...
| `parteienrecht-wahlkampffinanzierung-transparenz` | Prüft Wahlkampfkonto, Spenden, Sachleistungen, Rechnungen, Plakate, Anzeigen und Nachweisführung. |
...
| `parteigruendung` | Begleitet Gründung: Programm, Satzung, Vorstand, Mitglieder, demokratische Ordnung, Anzeige, Konto und Website im Parteienrecht. |
...
| `parteiprogramm-formal-parteitag-planung` | Hilft beim formal korrekten Programm-/Grundsatzbeschluss ohne politische Inhaltsberatung im Parteienrecht. |
...
| `plakate-sondernutzung-presse-richtigstellung` | Routet Plakatierung, Sondernutzung, kommunale Satzung, Gleichbehandlung, Fristen und Entfernung im Parteienrecht. |
...
| `rechenschaft-rechenschaftsbericht-satzung` | Bereitet interne/gesetzliche Prüfung, Vorstandserklärung, Nachweise, Stichproben und Fehlerkorrektur vor im Parteienrecht. |
| `rechenschaftsbericht` | Strukturiert Einnahmen-/Ausgabenrechnung, Vermögensbilanz, Erläuterung, Gebietsverbände und Aufbewahrung im Parteienrecht. |
...
| `satzungsaenderung-partei-satzungsautonomie` | Prüft Satzungsänderung, Mehrheit, Antragsfrist, Bekanntmachung, Protokoll, Anzeige und Folgeänderungen im Parteienrecht. |
...
| `spendenrecht-partei-sponsoring-staatliche` | Prüft Annahme, Verbotstatbestände, Identität, Bargeld, ausländische Spenden, Veröffentlichung und Weiterleitung im Parteienrecht. |
...
| `unterstuetzungsunterschriften` | Prüft, ob Unterstützungsunterschriften nötig sind, Formblätter, Wahlberechtigung, Bescheinigung, Sammlung und Fehlerquellen im Parteienrecht. |
...
| `vertreterversammlung-vorstandswahl-partei` | Prüft Delegiertenwahl, Vertreterversammlung, Mandatsprüfung, Ersatzdelegierte und Legitimation im Parteienrecht. |
...
| `wahlanfechtung-intern-wahlkampffinanzierung` | Prüft Einspruch gegen interne Vorstandswahl oder Kandidatenaufstellung nach Satzung, Frist, Zuständigkeit und Beweisen im Parteienrecht. |
| `wahlkampffinanzierung` | Prüft Wahlkampfkonto, Spenden, Sachleistungen, Rechnungen, Plakate, Anzeigen und Nachweisführung im Parteienrecht. |
...
| `wahlordnung-intern-wahlvorschlag-bundestag` | Regelt geheime Wahl, Kandidaturen, Vorstellung, Stimmzettel, Auszählung, Stichwahl, Wahlanfechtung im Parteienrecht. |
...
- **Sparversion öffnen:** [`unified-mini-prompts/parteienrecht-parteiorganisation.md`](../unified-mini-prompts/parteienrecht-parteiorganisation.md)
...
- **Großer Mega-Prompt nur zur Anschauung im Repo:** [`testakten/megaprompts/parteienrecht-parteiorganisation.md`](../testakten/megaprompts/parteienrecht-parteiorganisation.md) (28 KB)
