...
| **Alle Skills als Markdown** | [`pruefungsrecht-hochschule-skills-markdown.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/pruefungsrecht-hochschule-skills-markdown.zip) |
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`pruefungsrecht-hochschule.md`](../unified-mini-prompts/pruefungsrecht-hochschule.md) oder als Sammel-ZIP [`alle-unified-mini-prompts.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/alle-unified-mini-prompts.zip) |
...
Dieses Plugin ist der robuste Prüfungsrechts-Werkzeugkasten für Studierende, Hochschulen, Prüfungsämter und Anwälte: kein Bauchgefühl über Fairness, sondern Ordnung, Frist, Bewertungsrüge, Akteneinsicht und prozessfester nächster Schritt.
...
| `attest-anforderungen-auslandsanerkennung` | Prüft formale und materielle Anforderungen an Atteste in Prüfungsverfahren im Prüfungsrecht Hochschule. |
...
| `hilfsmittel-liste-pruefung` | Prüft zugelassene Hilfsmittel, Taschenrechner, Gesetzestexte, KI und Sanktionen im Prüfungsrecht Hochschule. |
| `ihk-handwerk-berufsabschluss` | Prüft berufsständische Prüfungen, Kammerverfahren, Akteneinsicht und Wiederholung im Prüfungsrecht Hochschule. |
...
| `zweitkorrektur-neubewertung-zweitpruefer` | Prüft Zweitkorrektur, Neubewertung und Austausch des Prüfers im Prüfungsrecht Hochschule. |
| `zweitpruefer-befangenheit` | Prüft Prüferbestellung, Befangenheit, Zweitkorrektur und Bewertungsunabhängigkeit im Prüfungsrecht Hochschule. |
...
- **Sparversion öffnen:** [`unified-mini-prompts/pruefungsrecht-hochschule.md`](../unified-mini-prompts/pruefungsrecht-hochschule.md)
...
- **Großer Mega-Prompt nur zur Anschauung im Repo:** [`testakten/megaprompts/pruefungsrecht-hochschule.md`](../testakten/megaprompts/pruefungsrecht-hochschule.md) (54 KB)
