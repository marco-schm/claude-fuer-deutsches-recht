...
| **Alle Skills als Markdown** | [`tabellenreview-3d-skills-markdown.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/tabellenreview-3d-skills-markdown.zip) |
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`tabellenreview-3d-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/tabellenreview-3d-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`tabellenreview-3d-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/tabellenreview-3d-unified-mini-prompt.md)
- **Großer Mega-Prompt nur zur Anschauung im Repo:** [`testakten/megaprompts/tabellenreview-3d.md`](../testakten/megaprompts/tabellenreview-3d.md) (72 KB)
