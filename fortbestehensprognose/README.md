...
| **Alle Skills als Markdown** | [`fortbestehensprognose-skills-markdown.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/fortbestehensprognose-skills-markdown.zip) |
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`fortbestehensprognose.md`](../unified-mini-prompts/fortbestehensprognose.md) oder als Sammel-ZIP [`alle-unified-mini-prompts.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/alle-unified-mini-prompts.zip) |
...
- **Sparversion öffnen:** [`unified-mini-prompts/fortbestehensprognose.md`](../unified-mini-prompts/fortbestehensprognose.md)
...
- **Großer Mega-Prompt nur zur Anschauung im Repo:** [`testakten/megaprompts/fortbestehensprognose.md`](../testakten/megaprompts/fortbestehensprognose.md) (119 KB)
