...
1. Arbeitsschritt Klägerstation Votum: Klageantrag, Streitgegenstand und passende Anspruchsgrundlagen in der Reihenfolge der Klägerstation festlegen.
...
- **Davor**: `06-schluessigkeit-pruefen` - Vorheriger Arbeitsschritt im selben Plugin; nutze ihn, wenn der Aktenstand noch nicht bis Klägerstation Votum trägt.
- **Danach**: `08-beklagtenvortrag-strukturieren` - Folgeschritt im selben Plugin; nutze ihn, sobald Klägerstation Votum entscheidungs- oder verfügungsreif vorbereitet ist.
