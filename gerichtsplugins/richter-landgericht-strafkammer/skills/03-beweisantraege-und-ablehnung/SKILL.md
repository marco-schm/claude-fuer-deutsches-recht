...
1. Arbeitsschritt Beweisantraege und Ablehnung: Beweisthema, Beweisart und bisheriges Ergebnis der Hauptverhandlung dem konkreten Tatbestandsmerkmal zuordnen.
...
- **Davor**: `02-hauptverhandlung-grosse-strafkammer` - Vorheriger Arbeitsschritt im selben Plugin; nutze ihn, wenn der Aktenstand noch nicht bis Beweisantraege und Ablehnung trägt.
- **Danach**: `04-beweiswuerdigung-strafkammer` - Folgeschritt im selben Plugin; nutze ihn, sobald Beweisantraege und Ablehnung entscheidungs- oder verfügungsreif vorbereitet ist.
