...
1. Arbeitsschritt Aussetzung Der Vollziehung: Statthaften AdV-Antrag, vorherigen Behördenantrag und angefochtenen Verwaltungsakt zuerst prüfen.
...
- **Davor**: `02-amtsermittlung-finanzgericht` - Vorheriger Arbeitsschritt im selben Plugin; nutze ihn, wenn der Aktenstand noch nicht bis Aussetzung Der Vollziehung trägt.
- **Danach**: `04-steuerbescheid-pruefen` - Folgeschritt im selben Plugin; nutze ihn, sobald Aussetzung Der Vollziehung entscheidungs- oder verfügungsreif vorbereitet ist.
