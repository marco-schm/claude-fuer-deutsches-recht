...
1. Arbeitsschritt Urteil Finanzgericht und Revision: Einspruchsentscheidung, Klagefrist, Klagebefugnis, Vorverfahren und finanzgerichtliche Zuständigkeit zuerst prüfen.
...
- **Davor**: `08-schaetzung-und-betriebspruefung` - Vorheriger Arbeitsschritt im selben Plugin; nutze ihn, wenn der Aktenstand noch nicht bis Urteil Finanzgericht und Revision trägt.
- **Danach**: `10-entscheidungsvorschlag-finanzgericht` - Folgeschritt im selben Plugin; nutze ihn, sobald Urteil Finanzgericht und Revision entscheidungs- oder verfügungsreif vorbereitet ist.
