...
| --- | --- | --- |
| **Verwaltungsgericht-Werkstatt** | Vollständiger Arbeits-Prompt mit Werkstattlogik, Pflicht-Schritten, Quellen-Disziplin und Antwort-Skeletten. Darf lang sein. | [`richter-verwaltungsgericht-werkstatt.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/richter-verwaltungsgericht-werkstatt.zip) |
| **Verwaltungsgericht-Schnellstart** | Kompakter Einstiegs-Prompt, höchstens 7.500 Zeichen. Für den schnellen Wurf in einen Chat. | [`richter-verwaltungsgericht-schnellstart.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/richter-verwaltungsgericht-schnellstart.zip) |

Wer die Markdown-Datei lieber im Browser ansehen statt herunterladen will:
- [`verwaltungsgericht-werkstatt.md`](./verwaltungsgericht-werkstatt.md) (im Browser ansehen)
- [`verwaltungsgericht-schnellstart.md`](./verwaltungsgericht-schnellstart.md) (im Browser ansehen)
...
- **Werkstatt-Prompt** (`verwaltungsgericht-werkstatt.md`)
- **Schnellstart-Prompt** (`verwaltungsgericht-schnellstart.md`)
