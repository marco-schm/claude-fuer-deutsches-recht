...
| **Alle Skills als Markdown** | [`beamtenrecht-skills-markdown.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/beamtenrecht-skills-markdown.zip) |
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`beamtenrecht.md`](../unified-mini-prompts/beamtenrecht.md) oder als Sammel-ZIP [`alle-unified-mini-prompts.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/alle-unified-mini-prompts.zip) |
...
- **Sparversion öffnen:** [`unified-mini-prompts/beamtenrecht.md`](../unified-mini-prompts/beamtenrecht.md)
...
- **Großer Mega-Prompt nur zur Anschauung im Repo:** [`testakten/megaprompts/beamtenrecht.md`](../testakten/megaprompts/beamtenrecht.md) (38 KB)
