...
6. **Betriebsrat vorhanden?** (Beteiligungsrechte bei Personalaktenmaßnahmen, Paragraf 83 BetrVG)
...
1. Liegt eine **arbeitsvertragliche Pflichtverletzung** vor (Hauptleistungspflicht, Nebenpflicht nach Paragraf 241 Abs. 2 BGB)?
...
| Schriftform empfohlen | Keine Pflicht, aber Beweissicherung (Paragraf 126 BGB analog); mündlich möglich, jedoch riskant |
...
| Keine Kopie in Personalakte | Beweisverlust | Aktenführung sicherstellen (Paragraf 83 BetrVG) |
