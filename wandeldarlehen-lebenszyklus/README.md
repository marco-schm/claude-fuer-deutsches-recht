...
| **Alle Skills als Markdown** | [`wandeldarlehen-lebenszyklus-skills-markdown.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/wandeldarlehen-lebenszyklus-skills-markdown.zip) |
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`wandeldarlehen-lebenszyklus-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/wandeldarlehen-lebenszyklus-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`wandeldarlehen-lebenszyklus-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/wandeldarlehen-lebenszyklus-unified-mini-prompt.md)
- **Großer Mega-Prompt nur zur Anschauung im Repo:** [`testakten/megaprompts/wandeldarlehen-lebenszyklus.md`](../testakten/megaprompts/wandeldarlehen-lebenszyklus.md) (116 KB)
