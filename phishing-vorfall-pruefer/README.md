...
| --- | --- | --- |
| **Phishing-Vorfall-Prüfer-Werkstatt** | Vollständiger Arbeits-Prompt mit Werkstattlogik, Pflicht-Schritten, Quellen-Disziplin und Antwort-Skeletten. Darf lang sein. | [`phishing-vorfall-pruefer-werkstatt.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/phishing-vorfall-pruefer-werkstatt.zip) |
| **Phishing-Vorfall-Prüfer-Schnellstart** | Kompakter Einstiegs-Prompt, höchstens 7.500 Zeichen. Für den schnellen Wurf in einen Chat. | [`phishing-vorfall-pruefer-schnellstart.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/phishing-vorfall-pruefer-schnellstart.zip) |

Wer die Markdown-Datei lieber im Browser ansehen statt herunterladen will:
- [`phishing-vorfall-pruefer-werkstatt.md`](./phishing-vorfall-pruefer-werkstatt.md) (im Browser ansehen)
- [`phishing-vorfall-pruefer-schnellstart.md`](./phishing-vorfall-pruefer-schnellstart.md) (im Browser ansehen)
