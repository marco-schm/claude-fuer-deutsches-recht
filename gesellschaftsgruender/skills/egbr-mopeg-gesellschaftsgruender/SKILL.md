...
description: "GbR nach MoPeG 2024 und Eintragung ins Gesellschaftsregister als eGbR vorbereiten. Normen: Paragraf 705 ff. BGB n.F. MoPeG, Paragraf 707 ff. BGB Gesellschaftsregister. Prüfraster: Eintragungsvoraussetzungen, Gesellschafterverzeichnis, Vertretungsregeln, Haftungsfolgen. Output: eGbR-Gründungsunterlagen. Abgre..."
---
...
- **Paragraf 705 II BGB** — Rechtsfaehige GbR bei Teilnahme am Rechtsverkehr; gesetzliche Anerkennung
- **Paragraf 707 BGB** — Freiwillige Eintragung in das Gesellschaftsregister (eGbR)
- **Paragraf 707a II BGB** — Pflicht-Namenszusatz "eGbR" / "eingetragene Gesellschaft buergerlichen Rechts"
- **Paragraf 707a III BGB** — Vertrauensschutz Dritter auf Registerpublizitaet (analog Paragraf 15 HGB)
- **Paragraf 707b BGB** — Pflicht-Eintragung bei Grundstuecksgeschaeften; Grundbuchverfahren
- **Paragraf 720 I BGB** — Grundsatz der Gesamtvertretung; Satzungsabweichung möglich
- **Paragraf 721 BGB** — Gesamtschuldnerische Aussenhaftung aller Gesellschafter (unbeschraenkt)
- **Paragraf 723 BGB** — Fortbestand der Gesellschaft bei Ausscheiden eines Gesellschafters (Kernneuerung MoPeG)
...
|---|---|---|---|
| 1 | Aussen-GbR mit Rechtsverkehrsteilnahme? | Paragraf 705 II BGB | Ja: rechtsfaehig. Nein: Innen-GbR |
| 2 | Grundstuecksgeschaeft geplant? | Paragraf 707b BGB | Ja: Pflicht-Eintragung VOR Notar-Termin |
| 3 | GmbH-Anteilsbeteiligung? | Paragraf 40 GmbHG | Ja: eGbR-Eintragung Voraussetzung |
| 4 | Handelsgeschaeft? | Paragraf 1 HGB | Ja: OHG statt eGbR (Handelsregister) |
| 5 | Haftungsbeschraenkung gewuenscht? | Paragraf 721 BGB | eGbR bietet keine; GmbH/KG prüfen |
| 6 | Vertrauensschutz für Geschäftspartner gewuenscht? | Paragraf 707a III BGB | Eintragung schafft Publizitaet |
| 7 | Bestehendes Grundbuch auf alte GbR? | Paragraf 47 GBO | Umschreibung auf eGbR nach Eintragung |
...
3. **Gesellschaftsvertrag entwerfen** (formfrei, aber schriftlich empfohlen): Gegenstand, Einlagen, Vertretung, Gewinnverteilung, Ausscheiden, Fortbestandsklausel (Paragraf 723 BGB).
...
7. **Folge-Anmeldungen:** Gewerbeamt, Finanzamt, Transparenzregister (Paragraf 20 GwG).
...
- Eintragung = Haftungsbeschraenkung: FALSCH. Alle Gesellschafter haften weiter unbeschraenkt (Paragraf 721 BGB)
- GbR als GmbH-Gesellschafter ohne eGbR: Eintragung in Gesellschafterliste nicht möglich (Paragraf 40 GmbHG)

## Quellen und Vertiefung

- Paragraf 705-740 BGB (MoPeG-Fassung ab 01.01.2024): https://www.gesetze-im-internet.de/bgb/__705.html
- Paragraf 707, 707a, 707b BGB (Gesellschaftsregister; Voreintragungserfordernis Grundstuecksgeschaefte): https://www.gesetze-im-internet.de/bgb/__707.html
