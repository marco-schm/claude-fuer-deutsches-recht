...
| **Alle Skills als Markdown** | [`gesellschaftsgruender-skills-markdown.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/gesellschaftsgruender-skills-markdown.zip) |
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`gesellschaftsgruender.md`](../unified-mini-prompts/gesellschaftsgruender.md) oder als Sammel-ZIP [`alle-unified-mini-prompts.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/alle-unified-mini-prompts.zip) |
...
- **Sparversion öffnen:** [`unified-mini-prompts/gesellschaftsgruender.md`](../unified-mini-prompts/gesellschaftsgruender.md)
...
- **Großer Mega-Prompt nur zur Anschauung im Repo:** [`testakten/megaprompts/gesellschaftsgruender.md`](../testakten/megaprompts/gesellschaftsgruender.md) (86 KB)
