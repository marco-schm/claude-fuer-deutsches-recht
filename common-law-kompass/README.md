...
| --- | --- | --- |
| Plugin als Komplett-ZIP (Hauptweg, für Claude Code / Cowork) | ZIP | [`common-law-kompass.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/common-law-kompass.zip) |
| Großer Prompt (Werkstatt, Alternative ohne Plugin-Setup) | Markdown | <a href="https://raw.githubusercontent.com/Klotzkette/claude-fuer-deutsches-recht/main/common-law-kompass/common-law-kompass-werkstatt.md" download><code>common-law-kompass-werkstatt.md</code></a> |
| Kleiner Prompt (Schnellstart, höchstens 7500 Zeichen, Spar-Alternative) | Markdown | <a href="https://raw.githubusercontent.com/Klotzkette/claude-fuer-deutsches-recht/main/common-law-kompass/common-law-kompass-schnellstart.md" download><code>common-law-kompass-schnellstart.md</code></a> |
...
| `commercial-sonderfall-und-edge-case` | Commercial: Sonderfall und Edge-Case-Prüfung. |
| `common-consideration-discovery` | Common: Erstprüfung, Rollenklärung und Mandatsziel. |
| `common-law-kompass-schnellstart` | 'Kompakter Arbeitsmodus für Common-Law-Kompass für deutsche Wirtschaftsjuristen. Er beginnt mit den vorhandenen Dateien, wählt die passenden Skill-Stationen und liefert ein ausformuliertes Ergebnis mit Quellen- und Stop-Kontrolle.' |
| `consideration-behoerden-gericht-und-registerweg` | Consideration: Behörden-, Gerichts- oder Registerweg. |
...
| `discovery-zahlen-schwellen-und-berechnung` | Discovery: Zahlen, Schwellenwerte und Berechnung. |
...
| `drafting-interessen-explainer-beweislast` | Drafting: Mehrparteienkonflikt und Interessenmatrix. |
...
| `explainer-beweislast-und-darlegungslast` | Explainer: Beweislast, Darlegungslast und Substantiierung. |
...
| `reviews-internationaler-bezug-und-schnittstellen` | Reviews: Internationaler Bezug und Schnittstellen. |
...
| `suretyship-schriftsatz-brief-und-memo-bausteine` | Suretyship: Schriftsatz-, Brief- und Memo-Bausteine. |
