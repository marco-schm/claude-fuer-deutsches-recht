...
| **Alle Skills als Markdown** | [`gebrauchsmusterrecht-skills-markdown.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/gebrauchsmusterrecht-skills-markdown.zip) |
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`gebrauchsmusterrecht.md`](../unified-mini-prompts/gebrauchsmusterrecht.md) oder als Sammel-ZIP [`alle-unified-mini-prompts.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/alle-unified-mini-prompts.zip) |
...
- **Sparversion öffnen:** [`unified-mini-prompts/gebrauchsmusterrecht.md`](../unified-mini-prompts/gebrauchsmusterrecht.md)
...
- **Großer Mega-Prompt nur zur Anschauung im Repo:** [`testakten/megaprompts/gebrauchsmusterrecht.md`](../testakten/megaprompts/gebrauchsmusterrecht.md) (43 KB)
