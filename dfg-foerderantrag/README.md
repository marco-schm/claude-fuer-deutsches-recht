...
| --- | --- | --- |
| Plugin als Komplett-ZIP (Hauptweg, für Claude Code / Cowork) | ZIP | [`dfg-foerderantrag.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/dfg-foerderantrag.zip) |
| Großer Prompt (Werkstatt, Alternative ohne Plugin-Setup) | Markdown | <a href="https://raw.githubusercontent.com/Klotzkette/claude-fuer-deutsches-recht/main/dfg-foerderantrag/dfg-foerderantrag-werkstatt.md" download><code>dfg-foerderantrag-werkstatt.md</code></a> |
| Kleiner Prompt (Schnellstart, höchstens 7500 Zeichen, Spar-Alternative) | Markdown | <a href="https://raw.githubusercontent.com/Klotzkette/claude-fuer-deutsches-recht/main/dfg-foerderantrag/dfg-foerderantrag-schnellstart.md" download><code>dfg-foerderantrag-schnellstart.md</code></a> |
...
| `adaptive-dokumentenmatrix-und-lueckenliste` | Adaptive: Dokumentenmatrix, Lückenliste und Nachforderung. |
| `anfaenger-antraege-dfg` | Anfaenger: Risikoampel, Gegenargumente und Verteidigungslinien. |
...
| `dfg-foerderantrag-schnellstart` | 'Kompakter Arbeitsmodus für DFG-Förderantrag. Er beginnt mit den vorhandenen Dateien, wählt die passenden Skill-Stationen und liefert ein ausformuliertes Ergebnis mit Quellen- und Stop-Kontrolle.' |
...
| `elan-ethik-finanzplan` | Elan: Formular, Portal und Einreichungslogik. |
...
| `ethik-abschlussprodukt-und-uebergabe` | Ethik: Abschlussprodukt und Übergabe. |
...
| `finanzplan-mandantenkommunikation-entscheidungsvorlage` | Finanzplan: Mandantenkommunikation und Entscheidungsvorlage. |
| `foerderantragssteller-formalia-red-fuehrung` | Foerderantragssteller: Tatbestandsmerkmale, Beweisfragen und Beleglage. |
...
| `grosse-kleine-koselleck-interessen` | Grosse: Compliance-Dokumentation und Aktenvermerk. |
...
| `reviewer-beweislast-und-darlegungslast` | Reviewer: Beweislast, Darlegungslast und Substantiierung. |
| `sachbeihilfe-bis-200k-eigenanteil` | Sachbeihilfe: Fristen, Form, Zuständigkeit und Rechtsweg. |
