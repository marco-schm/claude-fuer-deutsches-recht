...
| **Alle Skills als Markdown** | [`prozessrecht-skills-markdown.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/prozessrecht-skills-markdown.zip) |
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`prozessrecht-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/prozessrecht-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`prozessrecht-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/prozessrecht-unified-mini-prompt.md)
